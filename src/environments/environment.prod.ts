...
export const environment = {
  ...
  redirectUri: typeof window !== 'undefined' ? window.location.origin + '/index.html' : '/index.html',
  postLogoutRedirectUri: typeof window !== 'undefined' ? window.location.origin + '/index.html' : '/index.html',
